...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EasyFind Property Solutions | Property Services in Bangalore" },
      { name: "description", content: "End-to-end residential real estate services in Bangalore. Rental, Sales, Property Management, NRI Assistance, and more." },
      { name: "author", content: "EasyFind Property Solutions" },
      { property: "og:title", content: "EasyFind Property Solutions | Property Services in Bangalore" },
